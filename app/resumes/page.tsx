    ...
    <div className="bg-[#F8FAFC] min-h-screen">
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <p className="text-sm text-[#64748B] mt-0.5">{total} специалистов готовы к работе</p>
        </div>
          ...
          <main className="flex-1 min-w-0">
            {loading ? (
              ...
              <div className="bg-white rounded-[16px] border border-[#E5E7EB] p-16 text-center">
                ...
                <h3 className="font-semibold text-[#0F172A] mb-1">Специалисты не найдены</h3>
                <p className="text-sm text-[#64748B] mb-4">Попробуйте изменить фильтры</p>
                <button onClick={() => onFilter(DEFAULT_RESUME_FILTERS)} className="text-sm text-[#7C3AED] hover:underline">Сбросить фильтры</button>
              </div>
            ) : (
              <>
